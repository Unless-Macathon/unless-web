        ...
        <div class="col-lg-16 mx-auto">
          ...
          {/* <form class> 
                <div class="input-group"> 
                    ...
                    <button class="btn" style={{color: '#7B2CBF', border: "2px solid #7B2CBF"}} type="submit"> 
          ...
          <div class="col-lg-10 mx-auto">
            <input type="text" class="form-control" placeholder="Search for Name, Postcode, Electorate...">
            </input>
            <button class="btn" style={{color: '#7B2CBF', border: "2px solid #7B2CBF"}} type="button">
            <NavLink className="" style={{color: '#7B2CBF', textDecoration: "none"}} to="/MP">
                        Search
                    </NavLink>
            </button>
